...
def test_amara_org_credit_is_discarded_without_pasting(monkeypatch, tmp_path, caplog):
    inserted: list[str] = []
    controller = make_controller(
        monkeypatch,
        tmp_path,
        [],
        inserted,
        transcription_text="Subtítulos realizados por la comunidad de Amara.org",
    )
